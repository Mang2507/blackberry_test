package com.onmobile.blackberry.application;
...
public class HelloBlackBerryScreen extends MainScreen {
	...
	public HelloBlackBerryScreen() {
		...
		basicEditField = new BasicEditField("Enter Your Last Name:", "", 100,
				BasicEditField.EDITABLE);
		add(basicEditField);

		ButtonField buttonField_1 = new ButtonField("Say Hello to GIT",
